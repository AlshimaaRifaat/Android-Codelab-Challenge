...
internal class CreateMemoViewModel : ViewModel() {
    ...
    /**
     * Call this method to update the memo with location data.
     */
    fun updateMemoWithLocation(title: String, description: String, latitude: Double, longitude: Double) {
        memo = Memo(title = title, description = description, id = 0, reminderDate = 0, reminderLatitude = latitude, reminderLongitude = longitude, isDone = false)
    }
